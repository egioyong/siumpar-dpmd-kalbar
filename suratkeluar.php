        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="suratkeluar.html"><i class="fas fa-table"></i><span>Surat Keluar</span></a></li>
                ...
                <div class="card shadow">
                    <div class="card-header py-3">
                        ...
                        <div class="col-md-12 search-table-col">
                            <div><a class="btn btn-primary btn-sm border rounded-0" role="button" style="color: #fff8f8;background-color: #1400ff;" href="form_suratkeluar.html"><i class="fa fa-plus"></i>Buat Arsip</a><a class="btn btn-primary btn-sm border rounded-0"
                                    role="button" style="color: rgb(255,255,255);background-color: #1400ff;"><i class="fa fa-print"></i>Print Arsip</a>
                                <hr>
                            </div>
                            <div style="width: 145px;">
                                <div class="dropdown"><button class="btn btn-primary btn-sm dropdown-toggle border rounded-0" data-toggle="dropdown" aria-expanded="false" type="button" style="background-color: #1400ff;color: rgb(255,255,255);">Cari Berdasarkan</button>
                                    <div
                                        class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="#" style="width: 145px;">Perihal</a><a class="dropdown-item" role="presentation" href="#" style="width: 145px;">No.Surat</a><a class="dropdown-item" role="presentation"
                                            href="#" style="width: 145px;">Tgl Surat</a>
                                        </div>
                                    </div>
                                <hr>
                                 </div>
