    ...
    <section id="contact" style="padding:40px;padding-right:5px;padding-left:4px;">
        <div class="container" style="background-color: #ffffff;">
            <form id="contactForm" style="padding:15px;" action="proses_tambah.php" method="post" enctype="multipart/form-data">
                <fieldset>
                    <legend class="text-center"><i class="fa fa-envelope"></i>&nbsp; Form SPT</legend>
                </fieldset>
                <div class="form-row" style="margin-left:0px;margin-right:0px;padding:10px;">
                    <div class="col-12 col-md-6" id="message" style="padding-right:20px;padding-left:20px;">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input class="form-control" type="text" id="no_sppd" name="no_spt" required="" placeholder="Nomor SPT">
                        </div>
                    </div>
                    <div class="col-12 col-md-6" id="message-1" style="padding-right:20px;padding-left:20px;">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input class="form-control" type="text" placeholder="Tujuan" name="tujuan">
                        </div>
                        <div class="form-group has-feedback">
                            <label for="kegiatan">Uraian Kegiatan</label>
                            <textarea class="form-control" name="kegiatan" placeholder="Uraian Kegiatan"></textarea>
                        </div>
                        <div class="form-group has-feedback">
                            <label for="lama">Lama Kegiatan</label>
                            <textarea class="form-control" name="lama" placeholder="Lama Kegiatan"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="file">File</label>
                            <hr><input type="file" name="file"></div>
                        <div class="form-group"><button class="btn btn-primary active btn-block" style="background-color: rgb(0,90,255);" type="submit" name="tambah">Tambah Data <i class="fa fa-chevron-circle-right"></i></button><a class="btn btn-primary active btn-block" role="button" style="background-color:#303641;"
                                href="dashboard.html">Kembali<i class="fa fa-chevron-circle-left"></i></a></div>
                    </div>
                </div>
            </form>
        </div>
