<?php
    include "koneksi.php";
    $result = mysqli_query($db, "SELECT * FROM disposisi");
?>
<!DOCTYPE html>
<html>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="disposisi.php"><i class="fas fa-book-open"></i><span>Disposisi Surat</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Disposisi Surat</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        ...
                        <hr>
                        <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Cari Disposisi"></div>
                        <div>
                            <div class="table-responsive table-bordered table table-hover table-bordered results">
                                <table class="table table-bordered table-hover">
                                    <thead class="bill-header cs">
                                        <tr>
                                            <th id="trs-hd" class="col-lg-1">Surat Dari</th>
                                            <th id="trs-hd" class="col-lg-2">Nomor Surat</th>
                                            <th id="trs-hd" class="col-lg-3">Tanggal Surat</th>
                                            <th id="trs-hd" class="col-lg-2">Tanngal Surat Diterima</th>
                                            <th id="trs-hd" class="col-lg-2">No.Agenda</th>
                                            <th id="trs-hd-4" class="col-lg-2">Sifat</th>
                                            <th id="trs-hd-3" class="col-lg-2">Diteruskan</th>
                                            <th id="trs-hd-2" class="col-lg-2">Dengan Hormat</th>
                                            <th id="trs-hd-1" class="col-lg-2">Catatan</th>
                                            <th id="trs-hd-5" class="col-lg-2">File</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $list["tgl_diterima"]; ?></td>
                                            <td><?= $list["no_agenda"]; ?></td>
                                            <td><?= $list["sifat"]; ?></td>
                                            <td><?= $list["diteruskan"]; ?></td>
                                            <td><?= $list["hormat"]; ?></td>
                                            <td><?= $list["catatan"]; ?></td>
                                            <td><?= $list["file"]; ?></td>
                                            <td>
                                                <a class="btn btn-primary" role="button" style="width: 54px;height: 44px;color: rgb(255,255,255);background-color: #ff0000;" href="view_disposisi.html">
                                                <i class="fas fa-book-open"></i></a><a class="btn btn-primary"
                                                    role="button" style="width: 54px;height: 44px;color: rgb(255,255,255);background-color: #0019ff;" href="edit_disposisi.html"><i class="far fa-edit"></i></a>
                                                <button class="btn btn-primary" type="button" style="width: 54px;height: 44px;color: rgb(255,255,255);background-color: #0c6121;"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                    </tbody>
